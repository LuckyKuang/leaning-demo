...
public class MqttController {
    ...
    public ResponseEntity<Boolean> subscribeMsb(String topic, Integer qos){
        return ResponseEntity.ok(mqttPublish.subscribeMqttMessage(topic,qos));
    }

    @GetMapping("unsubscribeMsg")
    public ResponseEntity<Boolean> unsubscribeMsg(String topic){
        return ResponseEntity.ok(mqttPublish.unsubscribeMqttMessage(topic));
    }
}
