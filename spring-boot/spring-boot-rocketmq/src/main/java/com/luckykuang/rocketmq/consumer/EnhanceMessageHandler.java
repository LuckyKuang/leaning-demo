...
import com.luckykuang.rocketmq.constant.MessageConstant;
...
public abstract class EnhanceMessageHandler<T extends BaseMessage> {
     ...
     * 延时等级
     */
    private static final int DELAY_LEVEL = MessageConstant.FIVE_SECOND;
    ...
    protected void handleRetry(T message) {
        ...
        if(!messageSource.startsWith(MessageConstant.RETRY_PREFIX)){
            message.setSource(MessageConstant.RETRY_PREFIX + messageSource);
        }
