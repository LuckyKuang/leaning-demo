...
public class ApachePoiTLServiceImpl implements ApachePoiTLService {
    ...
    private static final String OUTPUT_MKDIR = "output/";
    private static final String OUTPUT_FILENAME = "test.docx";

    @Override
    public void generateCharts() {
        try {
            File templateFile = new ClassPathResource("template/demo_template.docx").getFile();
            List<LabelData> generates = new ArrayList<>();
            //文本
            TextContentData contentData = new TextContentData();
            contentData.setContent("2024年月通报函生成报告").setLabelName("title").setTypeEnum(WordContentTypeEnum.TEXT);
            ...
            picData.setWidth(200).setHeight(160).setPicType(PicTypeEnum.JPG).setFile(new ClassPathResource("images/gaara.jpg").getFile())
            ...
            List<ChartSeriesRenderDataVO> lineRenderData = new ArrayList<>();
            ChartSeriesRenderDataVO numRenderData = new ChartSeriesRenderDataVO();
            ChartSeriesRenderDataVO moneyRenderData = new ChartSeriesRenderDataVO();
            ...
            List<ChartSeriesRenderDataVO> barRenderData = new ArrayList<>();
            ChartSeriesRenderDataVO openRenderData = new ChartSeriesRenderDataVO();
            ChartSeriesRenderDataVO moneyData = new ChartSeriesRenderDataVO();
            ...
            List<ChartSeriesRenderDataVO> areaRenderDatas = new ArrayList<>();
            ChartSeriesRenderDataVO areaRenderData = new ChartSeriesRenderDataVO();
            ...
            List<ChartSeriesRenderDataVO> lateralRenderData = new ArrayList<>();
            ChartSeriesRenderDataVO lateralYearData = new ChartSeriesRenderDataVO();
            ChartSeriesRenderDataVO lateralMoneyData = new ChartSeriesRenderDataVO();
            ...
            List<ChartSeriesRenderDataVO> groupRenderData = new ArrayList<>();
            ChartSeriesRenderDataVO unOpenData = new ChartSeriesRenderDataVO();
            ChartSeriesRenderDataVO openRadioData = new ChartSeriesRenderDataVO();
            ...
            //生成word
            OperateWordManage.generateWordContent(templateFile,OUTPUT_MKDIR + OUTPUT_FILENAME,generates);
