 ...
 */
public class SerialPortReceiveDataHexListener implements SerialPortDataListener {
    private final SerialPortHexCallback serialPortHexCallback;

    public SerialPortReceiveDataHexListener(SerialPortHexCallback serialPortHexCallback) {
        this.serialPortHexCallback = serialPortHexCallback;
    }
    ...
    public void serialEvent(SerialPortEvent serialPortEvent) {
        ...
        // 可用的监听事件数据
        if (serialPortHexCallback != null && Objects.equals(eventType,LISTENING_EVENT_DATA_AVAILABLE)) {
            serialPortHexCallback.dataAvailable(serialPort.getSystemPortName());
        }
    }
}
